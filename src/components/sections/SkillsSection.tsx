...
import { Megaphone, Settings2, Code2, Target, GitBranch, Zap, Mail, FileText, Users, Database, Braces, Globe, Filter, Layers, BarChart2, RefreshCw, Briefcase } from 'lucide-react';
import { SiHubspot, SiHtml5 } from 'react-icons/si';
...
const CARDS: CardDef[] = [
  {
    ...
    skills: [
      { name: 'Salesforce Marketing Cloud', icon: <Briefcase size={12} color="#00A1E0" /> },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'AMPscript',                      icon: <Briefcase size={12} color="#00A1E0" /> },  
