...
const CARDS: CardDef[] = [
  {
    ...
    skills: [
    { name: 'Salesforce Marketing Cloud', icon: <img src="/salesforce.png" alt="Salesforce" style={{ width: 14, height: 14, flexShrink: 0 }} /> },
  ...
  },
  {
    ...
    { name: 'AMPscript',                      icon: <img src="/salesforce.png" alt="Salesforce" style={{ width: 14, height: 14, flexShrink: 0 }} /> },
